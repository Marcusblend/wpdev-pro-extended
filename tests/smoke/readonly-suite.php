...
S::check(($init['result']['serverInfo']['version'] ?? null) === '1.2.0' && ($init['result']['protocolVersion'] ?? null) === '2025-03-26', 'initialize reports 1.2.0 and protocol 2025-03-26');
...
S::check(($info['pro_extended']['version'] ?? null) === '1.2.0', 'reports 1.2.0');
